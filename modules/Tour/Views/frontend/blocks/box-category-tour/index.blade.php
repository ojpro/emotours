@if($list_item)
    <div class="bravo-box-category-tour">
        <div class="container">
            ...
            @endif
            <div class="swiper-category p-4 h-50">
                <div class="list-item swiper-wrapper">
                    @foreach($list_item as $k=>$item)
                        ...
                        @if( !empty( $item_cat =  $categories->firstWhere('id',$item['category_id']) ))
                            ...
                            @endphp
                            <div class="item swiper-slide overflow-hidden">
                                <a href="{{ $page_search }}">
                ...
                <!-- Pagination -->
                <div class="swiper-category-pagination mx-auto"></div>
            </div>
        </div>
    </div>
@endif
