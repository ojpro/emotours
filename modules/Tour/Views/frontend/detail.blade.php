...
<script>
    jQuery(function ($) {
        <
        blade
        if |( % 24 row - % 3 Emap_lat % 20 % 26 % 26 % 20 % 24 row - % 3 Emap_lng) >
        new BravoMapEngine('map_content', {
            ...
            zoom: {
                {
                    %
                    24 row - % 3 Emap_zoom % 20 % 3 F % 3 F % 20 % 26 % 2334 % 3 B8 % 26 % 2334 % 3 B
                }
            },
...
<script type="text/javascript"
    src="{{ asset('module/tour/js/single-tour.js?_ver='.config('app.version')) }}">
</script>
@endsection
